...
return [
    'plugin' => [
        'name' => 'Builder',
        'description' => 'Proporciona herramientas visuales para la construcción de plugins de Winter CMS.',
        'add' => 'Crear plugin',
    ...
    'common' => [
        ...
        'field_icon_description' => 'Winter CMS usa Font Autumn icons: https://wintercms.com/docs/ui/icon',
